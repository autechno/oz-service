...
public class OperationTokenService {
    ...
    private final GoogleAuthCheckService googleAuthCheckService;
    ...
    public OperationTokenService(RedisTemplate<String, Object> redisTemplate, GoogleAuthCheckService googleAuthCheckService) {
        this.redisTemplate = redisTemplate;
        this.googleAuthCheckService = googleAuthCheckService;
    }
     ...
     * @param ip            IP
     */
    public String signToken(VerifyMethod verifyMethod, OperationEnum operationEnum, Long owner, String ip) {
...
//    }
    ...
    public boolean verifyToken(VerifyMethod verifyMethod, OperationEnum operationEnum, Long owner, String ip, String token) {
        String key = operationEnum.name() + verifyMethod.name() + owner + ip;
...
//    }
    ...
    public Boolean verifyIp(Integer terminal, String ipAddress) {
