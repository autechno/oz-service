...
public class IpLocation {
    ...
    public static String PATH = "/Applications/tomcat/apache-tomcat-8.5.43/conf/ip.dat";/*IpLocation.class.getResource("/data/ip.dat").toString().substring(5)*/;
    //public static String PATH = "/usr/apache-tomcat-8.5.43/conf/data/ip.dat";/*IpLocation.class.getResource("/data/ip.dat").toString().substring(5)*/;
    //public static String PATH = IpLocation.class.getResource("/data/ip.dat").toString().substring(5);
    ...
    public static void main(String[] args) {
        ...
        String address=location.findLocation("114.243.121.149");
