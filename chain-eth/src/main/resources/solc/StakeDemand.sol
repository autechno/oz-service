...
contract OZCoinDemandStake is Ownable {
...
//        address accountAddress = msg.sender;
    ...
    //确认 将在途币 滚入总额计息币
    function confirm() external onlyOwner returns (bool) {
    ...
    function settle(uint timestamp) external onlyOwner {
    ...
    constructor (address multiSignWalletAddress,address ozcContractAddress,address totoContractAddress) Ownable(msg.sender) {
