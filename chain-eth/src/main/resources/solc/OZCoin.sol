...
contract OZCoinToken is Ownable {

    using SafeMath for uint;

    string public constant name = "OZCoin";

    string public constant symbol = "OZCbeta1";
    ...
    constructor (address multiSignWalletAddress, address usdtERC20Address) Ownable(msg.sender) {
